          ...
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-gradient-to-br from-accent/10 via-white to-surface-overlay p-10 shadow-sm sm:p-14">
            ...
            <div className="relative mx-auto max-w-2xl text-center">
              <h2 className="text-2xl font-semibold tracking-tight text-ink sm:text-3xl">
                Generate a sample simulation for your role
              </h2>
              <p className="mt-3 leading-relaxed text-ink-muted">
                Paste any job description — any industry — sign in, and generate
                one free sample with real on-screen materials and a competency
                report. Need more? Email us for pricing.
              </p>
